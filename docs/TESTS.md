...
| `test_taches.py` | | les 54 tâches, systématiquement |
...
**Bloc `__main__`.** Son absence laisse le plugin se charger — 54 tâches
...
sources, la suite passait de cinq secondes à **cinquante-quatre**, et son
