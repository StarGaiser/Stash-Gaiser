...
|---|---|---|---|
| — | `i18n.py` | 1 411 | libellés, étiquettes, messages (7 langues) |
| — | `sources.py` | 574 | définition et poids des sources |
| — | `scoring.py` | 267 | familles, fiabilités, détecteurs de biais |
| — | `llm.py` | 240 | table des fournisseurs de modèles |
| 0 | `noyau.py` | 543 | contexte, réglages, état, sécurité, utilitaires |
| 1 | `similarite.py` | 128 | comparaison de noms (logique pure) |
| 1 | `collecte.py` | 406 | interrogation des sources, statistiques |
| 2 | `ia.py` | 356 | appels aux modèles, diagnostic, rédaction |
| 2 | `entites.py` | 193 | propositions, créations, restauration |
| 3 | `performers.py` | 349 | enrichissement des interprètes |
| 3 | `scenes.py` | 521 | enrichissement des scènes |
| 3 | `studios.py` | 180 | enrichissement des studios |
| 3 | `doublons.py` | 476 | détection et fusion |
| 3 | `groupes.py` | 356 | films en plusieurs parties |
| 5 | `gaizer.py` | 142 | registre des tâches et point d'entrée |
| — | `roles.py` | 190 | position et rapport de pouvoir (logique pure) |
| — | `tags.py` | 300 | familles de tags et mesures d'exclusion |
| — | `gaizer_page.js` | 380 | panneau de commande, tâches par intention |
| — | `scrapers.py` | 210 | scrapers manquants : détection et pose |
| — | `taches_diagnostic.py` | 519 | regarder sans rien changer |
| — | `taches_heritage.py` | 462 | champs venus d'un autre outil |
| — | `taches_arbitrage.py` | 282 | la seule famille qui écrase |
| — | `taches_menage.py` | 235 | retirer ce qui encombre |
| — | `taches_maintenance.py` | 197 | réparer l'installation |
| — | `gaizer.js` | 339 | actions injectées dans l'interface |
...
mode à sa fonction. **29 tâches, 45 réglages.**
...
|---|---|---|---|
| `doublons.py` | 0 % | 59 % | fusionne et **supprime** |
| `studios.py` | 0 % | 73 % | écrit sur les studios |
| `performers.py` | 8 % | 54 % | écrit sur les interprètes |
| `scenes.py` | 9 % | 40 % | écrit et relie |
| `entites.py` | 34 % | 80 % | crée et restaure |
| **Ensemble** | **30 %** | **47 %** | |
