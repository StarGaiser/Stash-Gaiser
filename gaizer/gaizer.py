...
from ia import generer_apercu
from profil import rapport_profil
from reglages import exporter_reglages, importer_reglages
...
from chemins import lire_chemins
from enchainement import enrichir_tout
from sprites import appliquer_generiques, lire_generiques
from vision import appliquer_vision, lire_vignettes
...
TASKS = {
    ...
    "appliquer_vision": appliquer_vision,
    "lire_generiques": lire_generiques,
    "appliquer_generiques": appliquer_generiques,
    "lire_chemins": lire_chemins,
    "enrichir_tout": enrichir_tout,
    ...
    "prompt_defaut": prompt_defaut,
    "generer_apercu": generer_apercu,
    "rapport_profil": rapport_profil,
    "exporter_reglages": exporter_reglages,
    "importer_reglages": importer_reglages,
    "noop": noop,
