...
(function () {
  ...
  const L = {
    ...
    m_aucun: {
      en: "No model configured — nothing will be written. Set "
          + "« Default model » in the plugin settings.",
      fr: "Aucun modèle configuré — rien ne sera écrit. Renseignez "
          + "« Modèle par défaut » dans les réglages du plugin.",
      de: "Kein Modell konfiguriert — es wird nichts geschrieben.",
      es: "Ningún modelo configurado — no se escribirá nada.",
      it: "Nessun modello configurato — non verrà scritto nulla.",
      pt: "Nenhum modelo configurado — nada será escrito.",
      nl: "Geen model geconfigureerd — er wordt niets geschreven." },
