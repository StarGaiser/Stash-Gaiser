...
SEUILS = {
    ...
    "entites": (75, "crée, restaure, marque"),
    "scrapers": (80, "installe du code tiers"),
    "vision": (68, "envoie des images à un tiers"),
    "doublons": (54, "fusionne et supprime des fiches"),
    "similarite": (85, "décide si deux fiches sont la même"),
    # ── Ce qui traite ────────────────────────────────────────────────
    "noyau": (72, "socle commun"),
    "ia": (65, "génération de textes"),
    "groupes": (68, "reconstitution des films"),
    "studios": (68, ""),
    "taches_heritage": (59, ""),
    "taches_arbitrage": (57, ""),
    "performers": (53, ""),
    "taches_diagnostic": (50, ""),
    "scenes": (45, ""),
    "collecte": (40, ""),
    "taches_menage": (77, ""),
    "i18n": (94, "tables de traduction"),
    "llm": (91, "catalogue de fournisseurs"),
    # ── Ce qui appelle l'extérieur ───────────────────────────────────
    "sources": (31, "requêtes distantes — éprouvées hors suite"),
    "taches_maintenance": (73, "réglages et migrations, peu de logique"),
}
