...
class TestReglages:
    ...
    def _lus_par_le_code(self) -> set:
        ...
        for conf in llm.DEFAUTS.values():
...
class TestTraductions:
    ...
    def test_tout_message_appele_existe(self):
        appeles = set(re.findall(r'\bctx\.t\(\s*["\']([a-z_]+)["\']', CODE))
...
class TestPageCommande:
    ...
    PAGE = (RACINE / "gaizer_page.js").read_text(encoding="utf-8")
